...
function GeneralLedger() {
  ...
  return (
    <div className="GeneralLedger">
      <div className="GeneralLedger__header px-4 shadow-sm">
        <button
          type="button"
      ...
      <div className="GeneralLedger__content my-3 rounded">
        ...
        <div className="GeneralLedger__content__filter py-3">
          <div className="GeneralLedger__content__filter__1 pt-3">
            <div>
              {!showFilter && (
                <button
          ...
          {showFilter && (
            <div className="GeneralLedger__content__filter__2 shadow-sm px-3 mt-3">
        ...
        <div className="GeneralLedger__content__data bg-white shadow-sm border">
          <div className="GeneralLedger__content__data__1  d-flex justify-content-between align-items-center">
            <table>
              ...
              <tbody className=" text-center py-1 px-3">
