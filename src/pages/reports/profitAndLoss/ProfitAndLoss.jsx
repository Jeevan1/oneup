...
function ProfitAndLoss() {
  ...
  return (
    <div className="ProfitAndLoss">
      <div className="ProfitAndLoss__header px-4 shadow-sm">
        <button
          type="button"
      ...
      <div className="ProfitAndLoss__content my-3 rounded">
        ...
        <div className="ProfitAndLoss__content__filter py-3">
          <div className="ProfitAndLoss__content__filter__1 pt-3">
            <div>
              {!showFilter && (
                <button
          ...
          {showFilter && (
            <div className="ProfitAndLoss__content__filter__2 shadow-sm px-3 mt-3">
        ...
        <div className="ProfitAndLoss__content__data bg-white shadow-sm border">
          <div className="ProfitAndLoss__content__data__1 py-3 d-flex justify-content-between px-3">
            <small>Account</small>
            <small>01/01/2023-31/12/2023</small>
          </div>
          <div className="ProfitAndLoss__content__data__2 px-2 pt-2 pb-4">
